        ...
        <div class="m-portlet__body">
          ...
          <form method="GET">
            <div class="row">
              ...
              <div class="ml-auto">
                <a href="{{url('/transits/create/'.$shipping_company->id)}}" class="btn btn-primary m-btn m-btn--icon m-btn--pill">
                  <span>
                    <i class="la la-plus"></i>
                    <span>{{__('nav.create')}}</span>
                  </span>
                </a>
                 <a href="{{url('/transits/trash/'.$shipping_company->id)}}" title="{{__('nav.trash')}}" class="btn m-btn btn-secondary m-btn--icon  m-btn--pill" >
                    ...
                    <td>
                      <div class="dropdown d-flex justify-content-end">             
                        ...
                        <div class="dropdown-menu dropdown-menu-right mt-3">
                          ...
                          <a class="dropdown-item" href="{{url('transits/manage/'.$transit->id)}}"><i class="fa fa-map-marker"></i> {{__('transit.manage')}}</a>                          
