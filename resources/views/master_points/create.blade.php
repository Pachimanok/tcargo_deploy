...
<div class="m-content">
  ...
  <div class="row">
    ...
    <div class="col-lg-12">
      ...
      <!--begin::Form-->
      <form action="{{url('/master_points/store')}}" method="post" class="m-form m-form--label-align-right">
        {{csrf_field()}}
            ...
            <div class="m-portlet">
              ...
              <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group">
                  ...
                  <textarea name="address" id="address" readonly class="form-control m-input  m-input--solid" placeholder="{{__('master_point.address_help')}}" rows="2">{{old('address')}}</textarea>
            ...
            <div class="m-portlet">
              ...
              <div class="m-portlet__body">
                <div class="form-group m-form__group">
                  ...
                  <input type="text" name="name" value="{{old('name')}}" class="form-control m-input" placeholder="{{__('master_point.name')}}">
                  @if ($errors->has('name'))
                      <div class="m-form__help text-danger">
                          {{ $errors->first('name') }}
                      </div>
                ...
                <div class="form-group m-form__group ">
                  ...
                  <textarea name="description" value="{{old('description')}}" class="form-control m-input" placeholder="{{__('master_point.description')}}" rows="4"></textarea>
