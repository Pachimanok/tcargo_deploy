                              ...
                              <div class="m-portlet__body">
                                   ...
                                   <div class="form-group m-form__group row">
                                        <div class="col-lg-3 ">
                                             ...
                                             <input type="text" name="phone_number_area_code" value="{{old('phone_number_area_code')}}" class="form-control m-input phone_area_validation" placeholder="{{__('driver.phone_number_area_code')}}">
