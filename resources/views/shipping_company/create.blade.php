  ...
  <div class="d-flex align-items-center">
    <div class="mr-auto">
      ...
      {{Breadcrumbs::make([
          ...
          Breadcrumbs::item(url()->current(), __('shipping_company.apply_as_shipping_company'), true),
      ])}}
    </div>
...
<div class="m-content">
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <!--begin::Form-->
      <form action="{{url('/shipping_companies/store')}}" method="post" class="m-form  m-form--label-align-right">
            ...
            <div class="m-portlet">
              ...
              <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                      ...
                      <input type="text" name="company_name" value="{{old('company_name')}}" class="form-control m-input" placeholder="{{__('shipping_company.company_name')}}">
                      @if ($errors->has('name'))
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" name="email" value="{{old('email')}}" class="form-control m-input" placeholder="{{__('shipping_company.email')}}">
                    @if ($errors->has('email'))
                        <div class="m-form__help text-danger">
                            {{ $errors->first('email') }}
                        </div>
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" name="contact_name" value="{{old('contact_name')}}" class="form-control m-input" placeholder="{{__('shipping_company.contact_name')}}">
                  ...
                  <div class="form-group m-form__group row">
                    <div class="col-lg-3 ">
                      ...
                      <input type="text" name="phone_number_area_code" value="{{old('phone_number_area_code')}}" class="form-control m-input phone_area_validation" placeholder="{{__('user.phone_number_area_code')}}">
                    ...
                    <div class="col-lg-9 ">
                      ...
                      <input type="text" name="phone_number" value="{{old('phone_number')}}" class="form-control m-input phone_number_validation" placeholder="{{__('user.phone_number')}}">
            ...
            <div class="m-portlet">
              ...
              <div class="m-portlet__body">
                <div class="form-group m-form__group">
                  ...
                  <input type="text" name="social_name" value="{{old('social_name')}}" class="form-control m-input" placeholder="{{__('shipping_company.social_name')}}">
                ...
                <div class="form-group m-form__group">
                  ...
                  <input type="text" name="fiscal_id_number" value="{{old('fiscal_id_number')}}" class="form-control m-input" placeholder="{{__('shipping_company.fiscal_id_number')}}">
              ...
              <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-lg-3 mb-3">
                    ...
                    <input type="text" name="address_number" value="{{old('address_number')}}" class="form-control m-input address_number_validation" placeholder="{{__('nav.address_number')}}">  
                ...
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-lg-4  mb-3">
                    ...
                    <input type="text" name="zip_code" value="{{old('zip_code')}}" class="form-control m-input zip_code_validation" placeholder="{{__('nav.zip_code')}}">  
