              ...
              <div class="m-portlet__body">
                  ...
                  <div class="form-group m-form__group row">
                    <div class="col-lg-3 ">
                      ...
                      <input type="text" name="phone_number_area_code" value="{{old('phone_number_area_code', $shipping_company->phone_number_area_code)}}" class="form-control m-input" placeholder="{{__('user.phone_number_area_code')}}">
                    ...
                    <div class="col-lg-9 ">
                      ...
                      <input type="text" name="phone_number" value="{{old('phone_number', $shipping_company->phone_number)}}" class="form-control m-input" placeholder="{{__('user.phone_number')}}">
              ...
              <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-lg-3 mb-3">
                    ...
                    <input type="text" name="address_number" value="{{old('address_number', $shipping_company->address_number)}}" class="form-control m-input" placeholder="{{__('nav.address_number')}}">  
                ...
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-lg-4  mb-3">
                    ...
                    <input type="text" name="zip_code" value="{{old('zip_code', $shipping_company->zip_code)}}" class="form-control m-input" placeholder="{{__('nav.zip_code')}}">  
